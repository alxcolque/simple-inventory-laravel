{{-- modal #returnToSupplierModal tiene los campos: cantidad, motivo, precio unitario --}}
<div class="modal fade" id="returnToSupplierModal" tabindex="-1" aria-labelledby="returnToSupplierModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="returnToSupplierModalLabel">Devolucion al proveedor</h5>
                <button type="button" class="btn-close text-light" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('return-to-supplier') }}" method="POST" autocomplete="off">
                    @csrf
                    @method('POST')
